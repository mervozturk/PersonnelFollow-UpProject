...
namespace Business.Concrete
{
    public class AddressManager : IAddressService
    {
        ...
        public IDataResult<List<Address>> GetByPersonnelId(int personnelId)
        {
            return new SuccessDataResult<List<Address>>(_addressDal.GetAll(a=>a.PersonnelId==personnelId),Messages.Listed);
        }
